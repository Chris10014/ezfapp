  ...
  return (
    <div className="container">
      ...
      <section>
        ...
        <p>
          Der Websitebetreiber erhebt, nutzt und gibt Ihre personenbezogenen Daten nur dann weiter, wenn dies im gesetzlichen Rahmen erlaubt ist oder Sie in die Datenerhebung einwilligen. Als personenbezogene Daten gelten sämtliche Informationen, welche dazu dienen, Ihre Person zu bestimmen und welche zu Ihnen zurückverfolgt werden können – also beispielsweise Ihr Name, Ihre E-Mail-Adresse und Telefonnummer. Diese Website können Sie auch besuchen, ohne Angaben zu Ihrer Person zu machen. Zur Verbesserung unseres Online-Angebotes speichern wir jedoch (ohne Personenbezug) Ihre Zugriffsdaten auf diese Website. Zu diesen Zugriffsdaten gehören z. B. die von Ihnen angeforderte Datei oder der Name Ihres Internet-Providers. Durch die Anonymisierung der Daten sind Rückschlüsse auf Ihre Person nicht möglich. Eine Anmeldung zur angebotenen, geschlossenen Veranstaltung kann nur unter Angabe persönlicher Daten erfolgen: Name, Vorname, Geburtsjahr, Geschlecht Optional werden Vereinszugehörigkeit und
          erwartete Zielzeit abgefragt. Berechtigt zur Anmeldung sind Personen, deren E-Mail Adresse vorgemerkt gespeichert wurde. Öffentlich zugänglich sind persönliche Daten über die Teilnehmer- und Ergebnisliste: Name, Vorname, aus dem Geburtsjahr und Geschlecht abgeleitete Altersklasse sowie die erreichte Zielzeit und Platzierung.
        </p>
